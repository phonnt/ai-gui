...
const MAC_APP = 'apps/desktop/src-tauri/target/release/bundle/macos/AI-GUI.app';
const MAC_SIDECAR = 'AI-GUI.app/Contents/MacOS/ai-gui-server';
...
function windowsSmoke(): void {
  ...
  const hasMain =
    existsSync(`${WIN_DIR}/AI-GUI.exe`) || existsSync(`${WIN_DIR}/ai-gui-desktop.exe`);
  if (!hasNsis || !hasMain) {
